...
public:
    CuckooHash()
    {
        ...
        table1_byte_operation = ByteOperations();
        table2_byte_operation = ByteOperations();
    ...
    void insert_block(Block block) {
        ...
        while (true)
        {
            int location = table1_byte_operation.ballToPseudoRandomNumber(block,conf.MU);
            ...
            location = table2_byte_operation.ballToPseudoRandomNumber(block,conf.MU);
    ...
    {
        int location1 = table1_byte_operation.ballToPseudoRandomNumber(key,conf.MU);
        int location2 = table2_byte_operation.ballToPseudoRandomNumber(key,conf.MU);
